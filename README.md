...
### DMT Radial Adjustment
- **Edge Correction**: DMT thickness measurements are automatically adjusted for wafer edge effects
- **Adjustment Zone**: Points with radius > 146mm from wafer center
- **Correction Value**: +175 Å added to DMT thickness values in the adjustment zone
- **Purpose**: Compensates for systematic measurement bias at wafer edge in DMT tool
- **Applied In**: DMT vs TFK comparisons and DMT vs BTM comparisons
